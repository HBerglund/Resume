...
export const jobs: Jobs = [
  {
    ...
    details: [
      ...
      {
        text: '• Responsible for timeline, budget and deliverables within projects',
      },
    ],
  },
  {
    ...
    details: [
      ...
      {
        text: '• Setting up routines including transportation, pre-delivery configurations such as image installations, asset management and recycling',
      },
      {
        text: '• Project groups including client representatives and internal Atea staff',
      },
      {
        text: '• Negotiating price and service contracts with manufacturers and distributors',
      },
      {
        text: '• Tender Work such as price negotiation with distributors, process documentation and making sure we delivered the tender response on time',
      },
      {
        text: '• Running Handover meetings with responsible Account Manager',
      },
      {
        text: '• Responsible for an internal group more oriented towards implementing global deliveries',
      },
    ],
  },
  {
    ...
    details: [
      {
        text: '• Managing a group of 16 Customer Service Representatives working primarily with incoming queries on chat, e-mail and phone',
      },
      {
...
export function formatName(nameString: string) {
